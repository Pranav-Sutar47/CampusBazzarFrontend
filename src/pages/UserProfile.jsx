...
//     try {
//       const token = localStorage.getItem('token');
//       const response = await fetch('https://hackathonbackend-7pkp.onrender.com/api/user/profileImage', {
//         method: 'POST',
//         headers: {
//           'Authorization': `Bearer ${token}`
...
//       const response = await fetch('https://hackathonbackend-7pkp.onrender.com/api/user/updateDetails', {
//         method: 'POST',
//         headers: {
